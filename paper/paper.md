---
title: 'Opfi: A Python package for identification of gene cassettes in large genomics or metagenomics datasets'
tags:
  - Python
  - genome mining
  - metagenomics
...
Opfi integrates the `DNAFeaturesViewer` package [@Zulkower:2020] to generate gene diagrams of candidate systems. Each input system is visualized as a single png image. Below is a simple script to visualize passing systems from the previous code snippet. A sample gene diagram is also provided. 
