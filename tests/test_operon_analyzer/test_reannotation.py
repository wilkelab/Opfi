...
def test_reannotate_operon():
    ...
    actual = reannotation._count_reannotations(operon, reannotated_operon)
...
def test_count_cluster_reannotations():
    ...
    actual = reannotation._count_cluster_reannotations([operon, operon2], {'operon1': reannotated_operon, 'operon2': reannotated_operon2})
